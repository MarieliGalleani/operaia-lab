...
const groups: readonly NavGroup[] = [
  {
    title: "Escritório",
    items: [
      { label: "Status", icon: "status", to: "/app/office/status" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Atividades", icon: "activity", to: "/app/office/atividades" },
    ],
  },
  {
    title: "Mundo",
  ...
  },
  {
    title: "Sistema",
    items: [
      { label: "Infra", icon: "server", to: "/app/office/vps" },
      ...
      <div v-for="group in groups" :key="group.title" class="nav-group">
        ...
        >
          <span class="nav-item__icon" aria-hidden="true">
            <svg v-if="item.icon === 'status'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75">
              <path d="M4 14h4v6H4zM10 9h4v11h-4zM16 4h4v16h-4z" />
            </svg>
            <svg v-else-if="item.icon === 'grid'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75">
